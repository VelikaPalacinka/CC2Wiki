		...
		<main className={style.main}>
			...
			<div className={style.description}>
				<article>
					...
					<p>
						The easiest method to see this output is to use a console application like
						Git Bash. Other methods such as running CC2 inside a programming IDE also
						work and allow you to see this output.
					</p>
				</article>
				<article>
					...
					<p>
						...
						things that wont help). With <code>-dev</code>, CC2 will re-load any local
						Lua script when it changes. This can be useful for rapid debug changes. If
						however you edit a game object XML file the game can crash when attempting
						to reload.
					</p>
				</article>
				<article>
				...
				<article>
					...
					<p>
						Lua's <code>print()</code> statement will print a string or number, if you
						want more complex output, you will need to pass it a formatted string
				...
				<article>
					...
					<p>
						<code>pcall()</code> works by accepting a single "callable" argument, this
						can be the name of a function or can be an anonymous function. It returns
