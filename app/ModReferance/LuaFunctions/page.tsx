				...
				<section>
					<article>
						...
						<p>
							...
							engine. They have a number of methods that we can use to find their type,
							location, speed, health, and loadout configuration etc.
						</p>
						<p>
					...
					<article>
						...
						<p>
							...
							It seems related to populating the lua object with up-to-date values from
							the native engine.
						</p>
						<p>
